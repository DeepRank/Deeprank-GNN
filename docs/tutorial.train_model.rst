...
You can get the `pre-trained model <https://github.com/DeepRank/Deeprank-GNN/tree/master/paper_pretrained_models/>`_ from DeepRank-GNN `github repository <https://github.com/DeepRank/Deeprank-GNN/>`
