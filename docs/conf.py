...
htmlhelp_basename = 'DeepRankGNNdoc'
...
latex_documents = [
    (master_doc, 'DeepRankGNN.tex', 'DeepRank-GNN Documentation',
     'Manon Reau, Nicolas Renaud', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'DeepRank-GNN', 'DeepRank-GNN Documentation',
     author, 'DeepRank-GNN', 'Graph Nerual Netowrk classification of protein-protein interface',
     'Miscellaneous'),
]
